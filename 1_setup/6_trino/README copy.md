...
Dieses Verzeichnis ist ein Fork von dem offiziellen Trino Chart.
Wir müssen den Chart forken, weil wir die deplyoments um weitere Volumes ergänzen mussten um damit wir die CA-Zertifikate via Init Container einbinden können.
